...
export class OrdersChartService extends OrdersChartData {
  ...
  constructor(private period: PeriodsService,private hoatDongService: HoatDongService) {
    super();
    this.data = {
      week: this.getDataForWeekPeriod(),
      month: this.getDataForMonthPeriod(),
      year: this.getDataForYearPeriod(),
      hoatDong: this.getHoatDongByMonth()
    };
  }

  private getHoatDongByMonth():any{
    let hoatDong:any
     this.hoatDongService.getByMonth(11,2023).then((res)=>{
      hoatDong=res
      console.log(res)
      return hoatDong
    })
